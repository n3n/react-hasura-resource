...
export type Operator = '_eq' |  '_neq' |  '_gt' |  '_lt' |  '_gte' |  '_lte' |  '_in' |  '_nin' | '_like' | '_nlike' | '_ilike' | '_nilike' | '_similar' | '_nsimilar' | '_is_null' | '_cast' | '_contains' | '_contained_in' | '_has_key' | '_has_keys_any' | '_has_keys_all' | '_st_contains' | '_st_crosses' | '_st_equals' | '_st_intersects' | '_st_overlaps' | '_st_touches' | '_st_within' | '_st_d_within' | '_st_intersects_rast' | '_st_intersects_nband_geom' | '_st_intersects_geom_nband'
